...
public class ThreeDRoiobjectGroupNode< K > extends ContentNode
{
	...
	private final Color3f color3 = new Color3f( CovistoModelView.DEFAULT_HIGHLIGHT_COLOR );
	 ...
	 * @param colors
	 */
	public ThreeDRoiobjectGroupNode( final Map< K, Point4d > centers, final Map< K, Color4f > colors )
	{
	 ...
	 */
	public ThreeDRoiobjectGroupNode( final HashMap< K, Point4d > centers, final Color3f color )
	{
		this.centers = new HashMap< >( centers );
